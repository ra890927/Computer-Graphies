...
ball_vertices = () => {
    ...
    const R = 1;
    var vertices = [];
    for(let out_angle = -90; out_angle < 90; out_angle += 10){
        let right_zdirection = R * Math.sin(out_angle * Math.PI / 180);
        let left_zdirection = R * Math.sin((out_angle + 10) * Math.PI / 180);
        let right_proj_radius = Math.abs(R * Math.cos(out_angle * Math.PI / 180));
        let left_prog_radius = Math.abs(R * Math.cos((out_angle + 10) * Math.PI / 180));

        for(let in_angle = 0; in_angle < 360; in_angle += 10){
            ...
            let right_top_x = right_proj_radius * Math.cos((in_angle + 10) * Math.PI / 180);
            let right_top_y = right_proj_radius * Math.sin((in_angle + 10) * Math.PI / 180);
            ...
            let left_top_x = left_prog_radius * Math.cos((in_angle + 10) * Math.PI / 180);
            let left_top_y = left_prog_radius * Math.sin((in_angle + 10) * Math.PI / 180);
...
cylinder_vertices = () => {
    ...
    for(let angle = 0; angle < 360; angle += 10){
        ...
        let right_x = R * Math.cos((angle + 10) * Math.PI / 180);
        let right_y = R * Math.sin((angle + 10) * Math.PI / 180);
